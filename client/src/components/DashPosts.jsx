  ...
  const handleDeletePost = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        // .filter((post) => post._id !== postIdToDelete): This part filters the previous state array (prev) to create a new array where each element's _id does not match the postIdToDelete.
        setUserPosts((prev) =>
